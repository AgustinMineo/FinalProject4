...
<body>
    ...
    <div class="card" style="width: 18rem;">
        ...
        <ul class="list-group list-group-flush text-center">
            ...
            <li class="list-group-item bg-light text-dark"><?php echo $keeper->getCellPhone() ?></li>
                ...
                <input type="checkbox" name="email" value="<?php echo $keeper->getEmail()?>"> <label for="">Reservar con este Keeper</label><!--/// Cambiar el email por el keeperID-->
            </ul>
    ...
    <div class="card" style="width: 18rem;">
       <!-- <img src="//<//?///php echo IMG_PATH ?><//?php if($keeper->getKeeperImg()){echo "<h1>imagen del keeper</h1>";}else{src="keeperDog.svg"}?>" class="card-img-top" alt="KEEPER IMG">-->
        ...
        <div class="card-body d-flex m-2">
        <input type="checkbox" name="petId" value="<?php echo $petSize->getPetId()?>"><label for="">Reservar con este pet</label>
        </div>
    </div>
    <?php
    }
